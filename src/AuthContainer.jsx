            ...
            <div className="d-flex justify-content-center align-items-center vh-100">
              ...
              <Form onSubmit={handleLogin} style={{ width: "500px", padding: "20px", color: "white" }}>
                ...
                <div className="d-flex align-items-center my-3 gap-2">
                  <Button variant="outline-primary" type="submit" className="w-100 icon-login-btn" style={{ borderRadius: '20px' }}>
                ...
                <div className="d-flex justify-content-center align-item-center">
                  <Button variant="outline-primary" type="submit" className="w-50 icon-login-btn" style={{ borderRadius: '20px' }}>
